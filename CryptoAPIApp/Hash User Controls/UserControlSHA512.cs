...
{
    public partial class UserControlSHA512 : UserControl
    {
        public UserControlSHA512()
        {
            InitializeComponent();
        }
        ...
        private void BtnHash_Click(object sender, EventArgs e)
        {
            ...
            HMACSHA512 hMAC512 = new HMACSHA512(utf8.GetBytes(textboxkey.Text));
            byte[] hashmessage = hMAC512.ComputeHash(utf8.GetBytes(textBox1.Text));
